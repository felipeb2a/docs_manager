<?php
	...
	if (strcmp($passwd, $_POST['password']) !== 0) {
		...
		$sql = "update users SET name = '".$_POST['name']."', email = '".$_POST['email']."', password = '".$hash."', isActive = '".$_POST['isActive']."', isAdmin = '".$_POST['isAdmin']."' where  id = '".$_POST['id']."'";

	} else{
		$sql = "update users SET name = '".$_POST['name']."', email = '".$_POST['email']."', isActive = '".$_POST['isActive']."', isAdmin = '".$_POST['isAdmin']."' where  id = '".$_POST['id']."'";
	}
